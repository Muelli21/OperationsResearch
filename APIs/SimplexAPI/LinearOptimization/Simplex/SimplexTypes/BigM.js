class BigM {
    ...
    solve() {
        ...
        while (simplexTableauStates.has(SimplexTableauState.BIG_M_FEASIBLE)) {
            ...
            if (simplexTableauStates.has(SimplexTableauState.INFEASIBLE)) {
                break;
            }
    ...
    checkOptimality() {
        ...
        for (let index of simplexTableau.getBasis()) {
            let variableType = simplexTableau.getVariableTypeVector()[index];
            if (variableType == SimplexVariableType.ARTIFICIAL_VARIABLE) {
                optimal = false;
                break;
            }
        }
